...
const CallToAction = () => {
  return (
    <div className="py-20 bg-pro-50">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto reveal">
          <h2 className="h2 mb-4 text-gradient-pro">Ready to build your custom AI agent?</h2>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <Link to="/documentation">
              <Button variant="outline" size="lg" className="border-pro-300 text-pro-700 hover:bg-pro-50">
                Learn More
              </Button>
            </Link>
          </div>
